...
NOMES = [
    'ivan', 'jessica', 'gustavo', ' sthefani', ' eliene', 'junior', 'paulo', 'andre',
    'flavio', 'cassio', 'cristiano', 'ronaldo', 'danilo', 'tevez', 'haland', 'de bruyne'
...
class Player(Pessoa):
    ...
    def capturar(self, pokemon):
        ...
        print(' {} capturado {}'.format(self, pokemon))
